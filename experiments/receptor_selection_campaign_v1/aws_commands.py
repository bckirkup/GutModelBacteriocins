...
if a.stage!='Q':
 if not a.approval_file or not a.approval_file.exists(): raise SystemExit(f'REFUSED: Stage {a.stage} requires a gate approval JSON')
 d=json.loads(a.approval_file.read_text()); need=m['gate_requires']
