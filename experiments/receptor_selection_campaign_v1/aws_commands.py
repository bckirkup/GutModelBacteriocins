...
if a.stage!='Q':
 ...
 try: d=json.loads(validate_input_path(a.approval_file).read_text())
 except (OSError,json.JSONDecodeError,PathValidationError) as e: raise SystemExit(f'REFUSED: Stage {a.stage} approval file unreadable: {e}')
 need=m['gate_requires']
